...
class RectangleTest {
    ...
    void setCoordinatesInt(){
        ...
        assertEquals("RECTANGLE 0.250000 0.250000 0.500000 0.500000",shape.toString());
    }
    ...
    void setCoordinatesDouble(){
        ...
        assertEquals("RECTANGLE 0.400000 0.200000 0.700000 0.800000",shape.toString());
    }
    ...
    void testConstructorX1OverX2(){
        ...
        assertEquals("RECTANGLE 0.400000 0.200000 0.900000 0.400000", shape.toString());
    }
    ...
    @Test
    void getCommand() {
        assertEquals(VectorCommand.RECTANGLE,shape.getCommand());
    }

    @Test
    void returnCopy() {
        DrawableVector rectangle2 = shape.returnCopy();
        assertTrue( (shape.isFilled()==rectangle2.isFilled()) &&
                (shape.getFillColor().equals(rectangle2.getFillColor())) &&
                (shape.getCommand() == rectangle2.getCommand()));
    }
    ...
    @Test
    void toString1() {
        assertEquals("RECTANGLE 0.500000 0.500000 0.750000 0.660000",shape.toString());
    }
}